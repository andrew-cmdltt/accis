...
class SalaryCalculation extends Component {
    ...
    onSubmit = (e) => {
        ...
        this.props.editReport(report, this.state.savedId);
    };
    ...
    render() {
        if (this.props.report.id) {
            ...
            this.state.savedId = this.props.report.id
...
export default connect(mapStateToProps, {editReport})(SalaryCalculation);